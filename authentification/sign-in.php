...
<div class=" flex flex-col p-5 space-y-5 z-10 bg-white pt-10 pb-10 rounded-2xl">
    ...
    <form action="sign-in-sql.php" method="post">
        ...
        <button type="submit" class="border-4 border-gray-400 p-1 px-4 rounded-2xl shadow-xl text-xl font-semibold hover:text-blue-800 hover:border-blue-800">Submit</button>
    </form>
